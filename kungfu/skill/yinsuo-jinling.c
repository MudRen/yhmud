...
([      "action": " "RED" 银索金铃之极意 "NOR"",
        ...
        "attack" : (int)this_player()->query_skill("whip")/4 + random((int)this_player()->query_skill("whip")/2),
        ...
        "damage" : (int)this_player()->query_skill("force")/3 + random((int)this_player()->query_skill("whip")/3),
        "lvl"    : 100,
        "skill_name" : "极意",
        "damage_type": "抽伤"
]),
