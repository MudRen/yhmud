...
([      "action": " "RED" 铁掌之极意 "NOR"",
        ...
        "dodge"  : (int)this_player()->query_skill("dodge", 1)/5 + random((int)this_player()->query_skill("force", 1)/3),
        "parry"  : (int)this_player()->query_skill("parry", 1)/5 + random((int)this_player()->query_skill("parry", 1)/3),
