...
([      "action": " "RED" 日月轮法之极意 "NOR"",
        ...
        "attack" : (int)this_player()->query_skill("hammer")/4 + random((int)this_player()->query_skill("hammer")/2),
        ...
        "damage" : (int)this_player()->query_skill("force")/3 + random((int)this_player()->query_skill("hammer")/3),
        "lvl"    : 100,
        "skill_name" : "极意",
        "damage_type": "挫伤"
]),
