...
([      "action": " "RED" 全真剑法之极意 "NOR"",
        "force"  : (int)this_player()->query_skill("force", 1)/4 + random((int)this_player()->query_skill("force", 1)/2),
        ...
        "damage" : (int)this_player()->query_skill("force", 1)/2 + random((int)this_player()->query_skill("sword", 1)),
        "lvl"    : 200,
        "skill_name" : "极意",
        "damage_type": "刺伤"
]),
